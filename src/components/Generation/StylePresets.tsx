    ...
    <div className="space-y-2 sm:space-y-3">
        ...
        {STYLE_PRESETS.map((preset) => {
          ...
          return (
            <motion.button
              ...
              disabled={disabled}
              className={`p-2 sm:p-3 rounded-lg transition-all duration-200 flex flex-col items-center space-y-1 text-center ${
                disabled
      ...
      {selectedPreset && (
        <motion.div
          ...
          className="p-1.5 sm:p-2 bg-gray-100 dark:bg-zinc-800/50 rounded border border-gray-300 dark:border-zinc-700"
        >
