        ...
        <div className="relative flex-1 bg-zinc-900 flex items-center justify-center min-h-0">
          {!hasImages ? (
            ...
            <>
              ...
              {canNavigate && loaded && (
                <>
                  <button
                    ...
                    className="absolute left-1 top-1/2 transform -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white p-1.5 rounded-full transition-all opacity-0 group-hover:opacity-100"
                  >
                    <ChevronLeft size={16} />
                  </button>
                  ...
                  <button
                    ...
                    className="absolute right-1 top-1/2 transform -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white p-1.5 rounded-full transition-all opacity-0 group-hover:opacity-100"
                  >
              ...
              {/* Pin Indicator */}
              {isPinned && (
                <div className="absolute top-2 right-2 bg-amber-500/90 text-amber-900 px-1.5 py-0.5 rounded-full text-xs font-medium">
                  Pinned
                </div>
              )}
            </>
                ...
                >
                  ...
                  {pinnedIndex === index && (
                    <div className="absolute -top-0.5 -right-0.5 w-3 h-3 bg-amber-500 rounded-full flex items-center justify-center">
                      <Pin size={6} className="text-amber-900" />
                    </div>
                  )}
                </button>
              ))}
